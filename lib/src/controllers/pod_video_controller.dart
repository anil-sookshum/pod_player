...
// Set volume between 0.0 - 1.0,
  ...
  Future<void> enableFullScreen(String tag, {bool? showControls}) async {
    ...
    if (!isFullScreen) {
      ...
      _enableFullScreenView(tag, showControls);
      isFullScreen = true;
  ...
  void _enableFullScreenView(String tag, bool? showControls) {
    if (!isFullScreen) {
  ...
  String calculateVideoDuration(Duration _duration) {
    ...
    final _totalSeconds =
        (_duration - Duration(minutes: _duration.inMinutes)).inSeconds.toString().padLeft(2, '0');

...
class _CustomVideoControllsState extends State<CustomVideoControlls> {
  ...
  Widget build(BuildContext context) {
    ...
    const videoTitle = Padding(
      padding:
          kIsWeb ? EdgeInsets.symmetric(vertical: 25, horizontal: 15) : EdgeInsets.only(left: 15),
      child: Text(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    sizeH20,
                    _iconButton('Hide progress bar on overlay hidden', Icons.hide_source,
                        onPressed: () {
                      setState(() {
                    ...
                    sizeH20,
                    _iconButton('Video Jump to 01:00 minute', Icons.fast_forward_rounded,
                        onPressed: () {
